...
export function SecurityAndCta() {
  return (
    <>
      ...
      >
        <div className="mx-auto max-w-7xl px-5 sm:px-8 lg:px-10">
          <div className="relative overflow-hidden rounded-[2.5rem] border-2 border-ink bg-primary-strong px-6 py-10 text-white shadow-lift sm:px-10 lg:grid lg:grid-cols-[0.85fr_1.15fr] lg:items-center lg:gap-16 lg:px-14 lg:py-14">
            <div
              className="pointer-events-none absolute -right-20 -top-24 size-80 rounded-[2.5rem] bg-accent/25 blur-[1px] [transform:rotate(12deg)]"
              aria-hidden="true"
            />
            <div className="relative mx-auto grid aspect-square max-w-[260px] place-items-center">
              ...
              <div className="absolute size-36 rounded-full bg-accent/20 blur-2xl" />
              <div className="relative grid size-28 rotate-3 place-items-center rounded-[2rem] border-2 border-ink bg-accent text-ink shadow-lift">
                <ShieldCheck size={50} strokeWidth={2} />
              </div>
            </div>
            <div className="relative mt-8 text-center lg:mt-0 lg:text-left">
              <p className="inline-flex items-center gap-2 rounded-full border border-accent/40 bg-white/10 px-4 py-1.5 text-xs font-extrabold uppercase tracking-[0.18em] text-accent">
      ...
      <section className="relative overflow-hidden border-t-2 border-ink bg-accent py-16 sm:py-24">
        <div
        ...
        <div className="relative mx-auto max-w-4xl px-5 text-center sm:px-8">
          ...
          <p className="mx-auto mt-4 max-w-xl text-base font-medium leading-7 text-ink/75 sm:text-lg">
          ...
          <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
            <Link
              href="/register"
              className="inline-flex min-h-12 items-center justify-center gap-2 rounded-2xl border-2 border-ink bg-ink px-8 py-3.5 text-sm font-extrabold uppercase tracking-wide text-accent shadow-lift transition hover:-translate-y-0.5 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-ink/30"
            >
