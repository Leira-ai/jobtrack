      ...
      <div className="grid min-h-screen lg:grid-cols-[0.95fr_1.05fr]">
        <aside className="relative hidden overflow-hidden border-r-2 border-ink bg-primary-strong p-12 text-white lg:flex lg:flex-col lg:justify-between xl:p-16">
          <div
            ...
            aria-hidden="true"
          >
            <div className="absolute -left-24 -top-24 size-96 rounded-[2.5rem] border-2 border-ink bg-secondary/25 blur-[1px] [transform:rotate(10deg)]" />
            <div className="absolute -bottom-24 -right-24 size-96 rounded-[2.5rem] border-2 border-ink bg-secondary [transform:rotate(-8deg)]" />
          ...
          <div className="relative max-w-lg py-12">
            <p className="inline-flex items-center rounded-full border border-white/20 bg-white/10 px-4 py-1.5 text-xs font-extrabold uppercase tracking-[0.18em] text-white">
          ...
          <figure className="relative max-w-md rounded-[1.75rem] border-2 border-ink bg-secondary p-6 text-ink shadow-lift [transform:rotate(-1deg)]">
            <Quote size={20} className="text-ink" aria-hidden="true" />
            <blockquote className="mt-3 text-sm font-medium leading-6 text-ink/80">
              “Sekarang saya selalu tahu lamaran mana yang perlu ditindaklanjuti
              dan apa yang harus disiapkan untuk wawancara berikutnya.”
            </blockquote>
            <figcaption className="mt-4 text-xs font-extrabold uppercase tracking-widest text-white/70">
        ...
        <section className="flex min-h-screen flex-col px-5 py-6 sm:px-8 lg:px-12 xl:px-20">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/"
              className="ml-auto inline-flex items-center gap-2 rounded-full border-2 border-ink/15 px-4 py-2 text-sm font-extrabold text-ink transition hover:border-ink focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
            >
